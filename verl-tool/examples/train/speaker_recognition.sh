...
# model_name=/cache/DramaSR_output/unnamed_version_20260308_013634/model_sft
model_name=/opt/huawei/explorer-env/checkpoint/longvideo_data/DramaSR_cleaned/cached_models/model_sft_v1
train_data=/opt/huawei/explorer-env/checkpoint/longvideo_data/DramaSR_cleaned/workspace/unnamed_version_20260308_013634/rl_data_all_1pct_apw_none_train.parquet
val_data=/opt/huawei/explorer-env/checkpoint/longvideo_data/DramaSR_cleaned/workspace/unnamed_version_20260308_013634/rl_data_all_1pct_apw_none_val.parquet
save_path=/cache/DramaSR_output/unnamed_version_20260308_013634/model_rl
rollout_data_dir=/cache/DramaSR_output/unnamed_version_20260308_013634/rollout_data/train
validation_data_dir=/cache/DramaSR_output/unnamed_version_20260308_013634/rollout_data/val

export project_dir=/opt/huawei/explorer-env/checkpoint/longvideo_data/DramaSR_cleaned
export drama_data_dir=drama_data
export version_dir=workspace/unnamed_version_20260308_013634
export drama_name_list=zhen_huan_zhuan
export label_prop_option_list=1pct_apw
...
export PYTHONPATH=$PYTHONPATH:${verl_tool_dir}/verl
...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "speaker_recognition" --workers_per_tool 8 &
server_pid=$!  ##HERE
