        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    if num_prompt_in_batch >= prompt_bsz: # full batch (not reaching here due to the last step)
                    ...
                    print(self.val_reward_fn is not None, self.global_steps, self.config.trainer.test_freq, self.config.trainer.save_freq)
                    # validate
                    if (
